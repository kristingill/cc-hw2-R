...
ggplot() +
  ...
  labs(x = "Date",
       ...
       color = "Model",
       title = "SSP 119 Temperature Projections")
```
...
ggplot(data = ssp_119, aes(x = temperature_c_noaa,
  ...
  theme_minimal() +
  geom_point() +
  labs(x = "NOAA Temperature Projections(C)",
       y = "MIROC Temperature Projections(C)")
```
...
ggplot() +
  ...
  labs(x = "Date",
       y = "Temperature (Celsius)",
       color = "Model",
       title = "SSP 585 Temperature Projections")
```
...
ggplot() +
  ...
  labs(x = "Date",
       y = "Temperature (Celsius)",
       color = "Model") +
  scale_colour_manual(labels = c("Historical", "NOAA SSP 119", "MIROC SSP 119", "NOAA SSP 585", "MIROC SSP 585"),
